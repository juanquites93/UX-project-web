...
@Component({
  ...
  template: `
    <div class="p-[2.1vw]">
      ...
      <div class="flex border border-alarma-border rounded-[0.5vw] overflow-hidden mb-[3.3vh] w-fit">
      ...
      <div class="flex gap-[3.2vw] mb-[3.3vh]">
        <!-- Problem Count -->
        <div>
        ...
        <div>
          ...
          <div class="flex flex-col gap-[0.5vw]">
            @for (op of operations; track op.name) {
              <label class="flex items-center gap-[0.5vw] border border-alarma-border rounded px-[1vw] py-[0.8vh] cursor-pointer hover:bg-gray-50 transition-colors">
